...
SOURCES += $$BASE/CaptureBox.cpp $$BASE/Chat.cpp $$BASE/Clock.cpp $$BASE/Button.cpp  $$BASE/MoveBox.cpp $$BASE/MyDialog.cpp $$BASE/MyMessageBox.cpp $$BASE/Cell.cpp $$BASE/orientation.cpp $$BASE/orientthread.cpp
