...
define('STRING_BACK_TO_SHOPPING', 'Вернуться к выбору товаров');
...
define('STRING_BEFORE_CATALOG', 'Добро пожаловать! В нашем магазине Вы найдете более сотни моделей настенных часов ручной работы. Эти замечательные изделия способны притягивать взгляд в любой обстановке и послужат стильным украшением для Вашего дома или прекрасным и необычным подарком Вашим близким.');

//Настенные часы с маятником - это аксессуар, способный подчеркнуть оригинальность интерьера вашей комнаты или кухни. Вы хотите украсить Ваш дачный домик /или коттедж? Часы этой серии также окажутся как нельзя кстати, они идеально подходят для уютной комнаты загородного дома. Повесьте на стену часы и Вашей спальне и засыпайте в тишине! Кварцевый механизм абсолютно бесшумен и очень долговечен.
...
define('CART_MY_CHOISE', 'Мои покупки');
...
define('ERROR_INPUT_PHONE', 'Пожалуйста, введите номер Вашего телефона');
define('ERROR_INPUT_NAME', 'Пожалуйста, введите Ваши ФИО');
define('ERROR_INPUT_COUNTRY', 'Пожалуйста, введите название Вашей страны');
define('ERROR_INPUT_CITY', 'Пожалуйста, введите название Вашего города');
define('ERROR_INPUT_ADDRESS', 'Пожалуйста, введите Ваш почтовый адрес');
