...
HEADERS += $$DIALOGS/AuthorizationDialog.h $$DIALOGS/CreateGameDialog.h $$DIALOGS/WaitJoinDialog.h $$DIALOGS/JoinGameDialog.h $$DIALOGS/FindGameDialog.h $$DIALOGS/WaitAgreeDialog.h $$DIALOGS/GameDialog.h $$DIALOGS/WaitDrawDialog.h  $$DIALOGS/ChatMessageDialog.h  $$DIALOGS/OptionsDialog.h $$DIALOGS/PromotionDialog.h $$DIALOGS/WalletDialog.h
HEADERS += $$UI/UI.h $$NETWORK/Client.h $$UI/MainWindow.h $$UI/GameScene.h $$UI/MainMenu.h 

SOURCES += $$BASE/Animation.cpp $$BASE/Board.cpp $$BASE/CaptureBox.cpp $$BASE/Chat.cpp $$BASE/Clock.cpp $$BASE/Button.cpp $$BASE/Global.cpp $$BASE/MoveBox.cpp $$BASE/MyDialog.cpp $$BASE/MyMessageBox.cpp $$BASE/Cell.cpp $$BASE/orientation.cpp $$BASE/orientthread.cpp
